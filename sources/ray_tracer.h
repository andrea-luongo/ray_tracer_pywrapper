...
namespace MyStructures
{
	...
	struct RAYTRACER_API PlaneIntersectionInfo
	{
		std::vector<num::float3> t_hits;
	};

	struct RAYTRACER_API Ray
	{
		num::float3 origin;
	...
	struct RAYTRACER_API RayIntersectionInfo
	{
		num::float3 normal;
		std::vector<float> t_hits;
	};

	class RAYTRACER_API BBox
	{
	public:
		num::float3 pMin;
		num::float3 pMax;
	...
	class RAYTRACER_API Sphere : public Primitive
	{
	protected:
		float radius;
		num::float3 center;
	...
	class RAYTRACER_API Triangle : public Primitive
	{
	protected:
		num::float3 v0;
		num::float3 v1;
